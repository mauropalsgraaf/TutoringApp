...
(function (ba) {
      ...
      init : function (a, b, c, f) {
        ...
        v(this.depMaps, u(this, function (a, b) {
          ...
          if ("string" === typeof a) {
            ...
            this.errback ? q(a, "error", u(this, this.errback)) : this.events.error && q(a, "error", u(this, function (a) {
              this.emit("error", a)
            }))
          }
          c = a.id;
    ...
    i = {
      ...
      configure : function (a) {
        ...
        a.shim && (B(a.shim, function (a, c) {
          H(a) && (a = {deps : a});
          if ((a.exports || a.init) && !a.exportsFn)a.exportsFn =
            i.makeShimExports(a);
          b[c] = a
        }), j.shim = b);
        ...
        B(h, function (a, b) {
          !a.inited && !a.map.unnormalized && (a.map = p(b, null, !0))
        });
  ...
  if ("undefined" === typeof define) {
    ...
    if (z && (y = x.head = document.getElementsByTagName("head")[0],
    ...
    g.load = function (b, c, d) {
      var e = b && b.config || {};
      if (z)return e = g.createNode(e, c, d), e.setAttribute("data-requirecontext", b.contextName), e.setAttribute("data-requiremodule", c), e.attachEvent && !(e.attachEvent.toString &&
      0 > e.attachEvent.toString().indexOf("[native code")) && !Y ? (M = !0, e
      .
